...
let
  apiGetProjectComments* {.deprecated: "Use `meta.apiGetComments` instead.".} = "https://gamefound.com/api/comments/getProjectComments".parseUrl
  apiGetComments       * = "https://gamefound.com/api/comments/getComments".parseUrl
